...
TU_df = pd.read_csv('/cluster/home/hugifl/TranscriptionalUnits/TU_start_end_added_promoters.tsv', sep='\t')
...
TU_df_updated.to_csv('/cluster/home/hugifl/TranscriptionalUnits/TU_start_end_added_promoters_updated.tsv', sep='\t', index=False)